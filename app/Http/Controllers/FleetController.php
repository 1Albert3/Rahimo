...
class FleetController extends Controller
{
    public function index()
    {
        ...
        return Inertia::render('Admin/Flotte', [
            'vehicules' => $vehicles,
            'stats' => $stats,
        ]);
    }
    ...
    public function speedAlertsIndex()
    {
        ...
        return Inertia::render('Admin/SpeedAlerts', compact('alerts', 'stats'));
    }
    ...
    public function tripsIndex()
    {
        ...
        return Inertia::render('Admin/Trajets', compact('trips', 'vehicles', 'drivers'));
    }
    ...
    public function maintenanceIndex()
    {
        ...
        return Inertia::render('Admin/Maintenance', compact('vehicles', 'upcoming', 'overdue', 'history', 'stats'));
    }
    ...
    public function planningIndex()
    {
        ...
        return Inertia::render('Admin/Planning', compact('trips', 'drivers', 'vehicles'));
    }
    ...
    public function gpsMap()
    {
        ...
        return Inertia::render('Admin/GpsMap', [
            'vehicules' => $vehicles,
        ]);
    }
