...
var Virtualizer = class {
  constructor(opts) {
    ...
    this.resizeItem = (index3, size4) => {
      var _a, _b;
      if (index3 < 0 || index3 >= this.options.count) return;
      let cachedSize;
      let itemStart;
      let key;
...
function calculateRange({
  ...
  const getStart = flat ? (index3) => flat[index3 * 2] : (index3) => measurements[index3].start;
  const getEnd = flat ? (index3) => flat[index3 * 2] + flat[index3 * 2 + 1] : (index3) => measurements[index3].end;
