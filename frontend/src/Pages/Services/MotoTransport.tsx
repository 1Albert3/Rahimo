...
export default function MotoTransport() {
        ...
        return (
            <div className="max-w-lg mx-auto px-4 py-16 text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    <Link to="/services/moto-transport" className="px-6 py-3 bg-primary text-white rounded-xl font-bold text-sm">Nouvelle demande</Link>
    ...
    return (
        <div className="max-w-lg mx-auto px-4 md:px-6 py-10">
            ...
            <motion.form onSubmit={e => { e.preventDefault(); post('/services/moto-transport'); }}
