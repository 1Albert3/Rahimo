...
import { storeGuichet } from '@/api/admin';

interface GuichetData { trajets: Trajet[]; }

export default function Guichet() {
    const { data, loading } = useApi<GuichetData>('/admin/guichet');
    ...
    const submit = async (e: React.FormEvent) => {
        ...
        await storeGuichet({
            ...
            passenger_phone: form_data.passenger_phone,
            payment_method: form_data.payment_method,
            trip_id: selectedTrajet.id,
                    ...
                    <section className="bg-white rounded-xl shadow-xl border border-outline p-6 shrink-0">
                        ...
                        <div className="space-y-3">
                            <div>
                                ...
                                <input type="text" value={form_data.passenger_name} onChange={(e) => setData('passenger_name', e.target.value)}
                            ...
                            <div>
                                ...
                                <input type="tel" value={form_data.passenger_phone} onChange={(e) => setData('passenger_phone', e.target.value)}
                                ...
                                {[
                                    ...
                                    <button key={`${opt.val}-${i}`} type="button"
                                        ...
                                        className={`flex flex-col items-center justify-center p-3 rounded-xl transition-all active:scale-[0.96] ${
                                            form_data.payment_method === opt.val
