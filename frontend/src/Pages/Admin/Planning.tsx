...
import { assignPlanning } from '@/api/admin';
...
interface PlanningData { trips: PlanningTrip[]; drivers: DriverItem[]; vehicles: VehicleItem[]; }

const stagger = { animate: { transition: { staggerChildren: 0.05 } } };
const fadeUp = { initial: { opacity: 0, y: 8 }, animate: { opacity: 1, y: 0 } };

export default function Planning() {
    const { data, loading } = useApi<PlanningData>('/admin/planning');
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        {trip.driver_name ? (
                                                            ...
                                                            <select defaultValue="" onChange={async e => {
                                                                ...
                                                                if (driverId) {
                                                                    await assignPlanning({ trip_id: trip.id, driver_id: driverId });
                                                                }
                                                            }}
