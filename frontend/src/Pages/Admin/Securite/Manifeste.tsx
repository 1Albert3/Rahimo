...
export default function Manifeste() {
    ...
    const { data, loading } = useApi<{ passagers: any[]; trajet: any }>(`/admin/securite/manifeste/${id}`);
    ...
    return (
        <div className="w-full max-w-5xl space-y-6">
            <Link to="/admin/securite" className="text-primary hover:underline text-sm flex items-center gap-1">
