        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" onClick={onClose}>
            <div className="bg-white rounded-xl shadow-xl p-6 max-w-md w-full mx-4" onClick={e => e.stopPropagation()}>
                ...
                <div className="flex gap-3">
                    ...
                    >Conserver</button>
                    <button onClick={() => post(`/bookings/${billet.id}/cancel`)} disabled={processing}
            ...
            <div className="bg-white rounded-xl shadow-xl p-6 max-w-lg w-full mx-4 max-h-[80vh] overflow-y-auto" onClick={e => e.stopPropagation()}>
                ...
                {!searched ? (
                    ...
                    <div className="space-y-2">
                        ...
                        {trips.length > 0 && (
                            <button onClick={() => post(`/bookings/${billet.id}/reschedule`)} disabled={!data.new_trip_id || processing}
            ...
            <div className="bg-white rounded-xl shadow-xl p-6 max-w-lg w-full mx-4" onClick={e => e.stopPropagation()}>
                ...
                {seats.length > 0 && (
                    <>
                        ...
                        <button onClick={() => post(`/bookings/${billet.id}/change-seat`)} disabled={data.seat_numbers.length !== (billet.seats_count ?? 1) || processing}
                            className="w-full py-3 rounded-xl bg-primary text-white font-bold text-sm hover:opacity-90 transition-opacity disabled:opacity-50"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="lg:col-span-2 space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <Link to="/voyages" className="text-xs text-primary hover:underline font-semibold">+ Nouveau ticket</Link>
                    </div>
                    ...
                    <motion.div className="space-y-3" variants={stagger} initial="initial" animate="animate">
                        {filtered.length === 0 && (
                            <div className="bg-white rounded-xl shadow-xl p-8 text-center">
                                ...
                                {filter === 'all' && <Link to="/voyages" className="text-primary hover:underline text-sm mt-2 inline-block">Réserver un voyage</Link>}
                            </div>
                        )}
                        {filtered.map((b) => {
                            const s = b.status;
                                ...
                                <div className="flex items-start justify-between gap-3">
                                    ...
                                    <div className="text-right shrink-0">
                                        ...
                                        <div className="flex items-center gap-2 mt-1.5 justify-end">
                                            ...
                                            <Link to={`/reservation/${{ booking: b.id }}`}
                    ...
                    <div>
                        <div className="flex items-center justify-between mb-3">
                            ...
                            <div className="flex items-center gap-2">
                                <Link to="/colis/envoyer" className="text-xs text-primary hover:underline font-semibold">+ Envoyer</Link>
                                <Link to="/colis/suivi" className="text-xs text-primary hover:underline font-semibold">Suivre</Link>
                            </div>
                        </div>
                        {myColis.length === 0 ? (
