...
export default function LostAndFound({ foundItems }: Props) {
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('services.public.lost-and-found.store'), {
...
LostAndFound.layout = (page: React.ReactNode) => (
    <GuestLayout title="Objets Trouvés" activeNav="Services">{page}</GuestLayout>
);