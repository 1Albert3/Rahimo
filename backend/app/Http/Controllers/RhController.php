...
class RhController extends Controller
{
    ...
    public function personnelShow(User $user)
    {
        ...
        $__data = compact('employe', 'contrats', 'documents', 'stats');
        if (request()->expectsJson()) return response()->json($__data);
        return response()->json($__data);
    }
    ...
    public function contratsIndex()
    {
        ...
        $__data = compact('contrats', 'employes');
        if (request()->expectsJson()) return response()->json($__data);
        return response()->json($__data);
    }
    ...
    public function congesIndex()
    {
        ...
        $__data = compact('conges', 'employes');
        if (request()->expectsJson()) return response()->json($__data);
        return response()->json($__data);
    }
    ...
    public function paieIndex()
    {
        ...
        $__data = compact('bulletins', 'period', 'totalBrut', 'totalNet', 'nbEmployes', 'employes');
        if (request()->expectsJson()) return response()->json($__data);
        return response()->json($__data);
    }
